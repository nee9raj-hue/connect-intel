-- Deploy 12: Campaign Engine V3 — full bootstrap (run once in Supabase SQL editor).
-- Creates campaigns_v3, campaign_recipients, campaign_events, campaign_stats + indexes.
