...
/** Company workspace: subscription, usage, and credits (not Connect Intel platform admin). */
export default function OrgBillingPanel({ onNavigate }) {
  const { user } = useApp()
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="max-w-md text-center bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
            ...
            <p className="mt-2 text-sm text-gray-500 leading-relaxed">
              Billing & recharge here is for <strong>customer workspaces</strong>. Use{' '}
              <strong>Support desk</strong> to view a customer account, record payments, or handle escalations.
            </p>
            <button
              type="button"
  ...
  return (
    <div className="panel-shell">
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '1.5rem', flexWrap: 'wrap', gap: 12 }}>
        <div>
          <h1 style={{ fontSize: 20, fontWeight: 500, margin: 0 }}>Billing & team</h1>
          <p style={{ fontSize: 13, color: '#718096', margin: '4px 0 0' }}>
            Your company subscription, usage, and credits — not Connect Intel internal admin.
          </p>
        </div>
