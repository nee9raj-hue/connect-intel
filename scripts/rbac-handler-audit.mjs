...
const PERM_RE =
  /assertOrgPermission|loadMetaUserAndAssertEditLeads|requireMarketingHubAccess|requireMarketingSendAccess|assertEditLeadsForPipelinePatch|assertPipelineDeleteAccess|requireOrgAdmin|requireAdmin|requireTeamWorkspace|consumeSearchQuota|userCanAccessContact|assertPipelineHubAccess|\bauthorize\(/
