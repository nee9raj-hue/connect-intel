 ...
 * @property {() => string} provider
 * @property {(req: object, res: object) => Promise<object|null>} resolveSessionUser
 * @property {(req: object) => Promise<object|null>} getSessionUser
 * @property {() => object} getPublicAuthConfig
 * @property {(res: object, providerId?: string) => Promise<object>} startSso
 * @property {(req: object, res: object, query?: object) => Promise<object>} completeSsoCallback
 *
 ...
 * @property {string} provider
 * @property {(key: string, data: Buffer|Uint8Array, options?: object) => Promise<{ url: string, key?: string, bytes?: number }>} put
 ...
 * @property {() => Promise<{ ok: boolean, configured?: boolean }>} [ping]
 *
