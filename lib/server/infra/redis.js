...
/** Long-lived Railway workers use TCP; Vercel serverless prefers REST when configured. */
function useTcpRedis() {
...
export async function testRedisConnection() {
  ...
  try {
    ...
    return {
      ok: val === '1',
      mode: useTcpRedis() ? 'ioredis' : getUpstashRestConfig() ? 'upstash-rest' : 'ioredis',
