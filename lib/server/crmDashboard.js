...
export function buildTeamDashboard(
  store,
  user,
  { period = 'week', memberUserId = null, light = false, detailed = false, timeZone = null } = {}
) {
  ...
  const activityByDay = buildActivityByDay(activityEntries, since, dashboardPeriod, scopedMemberUserId, tz)
  ...
  const dashboardV3 = buildDashboardIntelligenceV3({
    ...
    comparison: teamIntelligence.comparison || {},
    rollup: teamIntelligence.rollup || {},
    personal: Boolean(scopedMemberUserId) || !isAdmin,
    isAdmin,
  })
