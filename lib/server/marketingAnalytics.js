...
export function buildCampaignAnalyticsFromStats(campaign, events = []) {
  ...
  return finalizeCampaignEngagementStats({
    ...
    uniqueOpens,
    clickRate:
      stats.clickRate != null && sentForRates > 0 && uniqueClicks === 0
        ? stats.clickRate
        : sentForRates > 0
          ? Math.round((uniqueClicks / sentForRates) * 100)
          : 0,
    openRate:
      stats.openRate != null && sentForRates > 0 && uniqueOpens === 0
        ? stats.openRate
        : sentForRates > 0
          ? Math.round((uniqueOpens / sentForRates) * 100)
          : 0,
