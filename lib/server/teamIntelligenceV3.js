...
const FUNNEL_STAGES = [
  { id: 'unqualified', label: 'Unqualified', statuses: ['unqualified', 'new'] },
  { id: 'qualified', label: 'Qualified', statuses: ['qualified', 'contacted'] },
  { id: 'opportunity', label: 'Opportunity', statuses: ['opportunity', 'follow_up', 'replied'] },
  { id: 'onboarding', label: 'Onboarding', statuses: ['onboarding', 'won'] },
  { id: 'new_account', label: 'New Account', statuses: ['new_account'] },
  { id: 'active_trading', label: 'Active trader', statuses: ['active_trading'] },
  { id: 'at_risk', label: 'At risk', statuses: ['at_risk'] },
  { id: 'churned', label: 'Churned', statuses: ['churned'] },
