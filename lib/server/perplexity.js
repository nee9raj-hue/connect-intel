...
Requirements:
- ONLY include companies and people that clearly match "${userAsk}" — exclude unrelated exporters or generic lists.
- Real organizations in the requested geography when specified; company name required on every row.
- Include full business email and Indian mobile (+91) on as many rows as possible; do not invent contacts.
- Sort the most relevant matches first in the JSON array.`
}
