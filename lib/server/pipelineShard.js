...
/**
 * Table-first single-lead update: read one row, mutate, upsert — no full shard R+W.
 * The table is authoritative for CRM single-lead saves; we do not dual-write the JSON shard here.
 * Bulk/list paths still read the shard until those views migrate to pipeline_leads pagination.
