...
export function mergeLeadForClientLight(entry) {
  ...
  return {
    ...
    crm: {
      ...
      lastOrderCreatedAt: crm.lastOrderCreatedAt || lastOrderCreatedAtFromErp(entry.erp || entry.lead?.erp) || null,
...
export function mergeLeadForClientListMinimal(entry) {
  ...
  return {
    ...
    crm: {
      ...
      lastOrderCreatedAt: raw.lastOrderCreatedAt || lastOrderCreatedAtFromErp(entry.erp || lead.erp) || null,
