...
/** Deal pipeline stages — same as lead funnel except post-sale active_trading, plus RFQ for freight. */
export const DEAL_STAGES = ['rfq', ...CRM_STATUSES.filter((s) => s !== 'active_trading')]
