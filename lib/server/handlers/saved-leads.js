      ...
      if (list.fromTable) {
        return sendPipelineJson(
          ...
          user,
          {
            ...
            pipelineSource: list.fromSqlScope ? 'pipeline_leads_scoped_sql' : 'pipeline_leads_table',
    ...
    if (assignToUserId !== undefined) {
      ...
      if (!canAssignLead(user, entryBefore, assignToUserId)) {
        return sendJson(res, 403, {
          error: entryBefore.assignedToUserId
            ? 'Only company admins or the assigned rep can transfer this lead'
