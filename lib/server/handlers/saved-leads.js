...
import { assertOrgPermission, assertEditLeadsForPipelinePatch, permissionDeniedResponse } from '../permissionEnforce.js'
...
export default async function handler(req, res) {
  ...
  if (req.method === 'DELETE') {
    ...
    try {
      await assertOrgPermission(user, 'delete_leads', metaStore)
    } catch (permError) {
      const denied = permissionDeniedResponse(permError)
      return sendJson(res, denied.status, denied.body)
    }
