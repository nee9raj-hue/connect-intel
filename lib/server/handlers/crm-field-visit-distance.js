...
import { suggestDrivingDistance, isFieldVisitDistanceConfigured, fieldVisitDistanceProvider } from '../fieldVisitDistance.js'
...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    return sendJson(res, 200, {
      configured: isFieldVisitDistanceConfigured(),
      provider: fieldVisitDistanceProvider(),
    })
  }
