      ...
      try {
        ...
        if (!migration.applied) {
          return sendJson(res, 503, {
            ...
            hint: 'Run supabase/migrations/20260703120000_campaigns_v3_deploy12.sql in Supabase SQL editor, or set SUPABASE_DB_PASSWORD / SUPABASE_ACCESS_TOKEN on Vercel',
            verifyBefore,
            migration,
            detail: error?.message || String(error),
          })
