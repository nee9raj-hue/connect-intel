...
export function buildPlanSteps({ refined = false } = {}) {
  ...
  return [
    { id: 'intent', label: 'Sales intent detected', status: 'done' },
    { id: 'crm', label: 'CRM duplicate check', status: 'done' },
    { id: 'discovery', label: 'Company search (TradeIndia, IndiaMART, web)', status: 'done' },
    { id: 'people', label: 'Decision makers & contacts', status: 'done' },
    { id: 'merge', label: 'Merging & ranking', status: 'done' },
    { id: 'ready', label: 'Results ready', status: 'done' },
  ]
}
