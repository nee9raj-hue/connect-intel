...
const REFINE_RE =
  /\b(only|just|filter|narrow|excluding|except|limit to|exporting to|exports? to|ships? to|in delhi|from delhi|delhi ncr|in mumbai|in punjab)\b/i
...
export function parseDiscoveryRefinement(message) {
  ...
  const out = { exportCountries: [], cities: [], states: [], keywords: '' }
