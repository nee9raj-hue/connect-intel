...
function applyLeadAccess(lead, store, viewer, rank, options = {}) {
  ...
  const emailUnlocked = unlockedFields.includes('email')
  const phoneUnlocked = unlockedFields.includes('phone')
  const linkedinUnlocked = unlockedFields.includes('linkedin')
