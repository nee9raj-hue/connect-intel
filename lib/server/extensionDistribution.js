...
const CHROME_EXTENSION_ITEM_ID = 'bahhnjcdlpjoglipkjiamnobhikmdpkb'
const DEFAULT_CHROME_WEB_STORE_URL = `https://chromewebstore.google.com/detail/connect-intel/${CHROME_EXTENSION_ITEM_ID}`
...
export function getChromeWebStoreUrl() {
  ...
  if (url && /^https:\/\/chromewebstore\.google\.com\//i.test(url)) return url
