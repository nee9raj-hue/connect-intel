...
export function applyCrmVisualWorkflows(store, entry, { trigger, previousStatus, newStatus, actor, organizationId, meta = {}, firedRules = null } = {}) {
  ...
  for (const wf of workflows) {
    ...
    fired.push({
      workflowKey: wf.id,
      workflowType: 'crm_visual_workflow',
      trigger,
      ruleName: wf.name || null,
    })
  }
