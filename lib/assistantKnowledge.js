...
const TEAM_INTELLIGENCE_IN_CRM_ENABLED = false
const ACTIVITY_LOG_HUB_IN_CRM_ENABLED = false
...
export const ASSISTANT_NAV_PANELS = new Set([
  ...
  'contacts',
  'companies',
  ...(TEAM_INTELLIGENCE_IN_CRM_ENABLED ? ['crm-dashboard'] : []),
  ...(ACTIVITY_LOG_HUB_IN_CRM_ENABLED ? ['crm-log'] : []),
  'crm-calendar',
  'crm-sequences',
  'crm-automation',
  'marketing',
