...
export const ASSISTANT_FAQ = [
  {
    ...
    body:
      'Work Gmail is optional until you need send/receive in CRM. Open Work email in the sidebar (or a lead → Email tab) and connect once. Google sign-up only uses your basic profile — sensitive Gmail scopes are requested at connect time, after Google app verification.',
    navigate: { panel: 'my-email' },
  },
  {
    id: 'bulk-email',
    tags: ['bulk', 'email', 'selected', 'pipeline', 'list', '200'],
  ...
  },
  {
    ...
    body:
      'Company admins: Team & email → invite by work email. Teammates accept the link and join your workspace. Set permissions for who can manage pipeline and team settings.',
    navigate: { panel: 'team' },
  },
  {
    id: 'contacts',
