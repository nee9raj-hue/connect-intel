...
export const ASSISTANT_FAQ = [
  ...
  {
    id: 'chithi',
    tags: ['chithi', 'team', 'chat', 'messages', 'tasks', 'mention', 'slack'],
    title: 'Chithi',
    body:
      'Chithi is your team workspace: #general channel, direct messages, @ for teammates and # for customers (name, company, mobile), tasks, and meetings. Unread badge and sound while CRM is open; email when teammates are away.',
