...
describe('pipeline actor aliases', () => {
  ...
  it('keeps same-email aliases from the session user when the users blob is missing', () => {
    const ids = listPipelineActorIds({ users: [], organizationMemberships: [] }, 'org1', {
      id: 'user_4129a563-f77b-42bf-bb36-2559a5fc1546',
      email: 'kuldeep@xindus.net',
      name: 'Kuldeep Sharma',
      pipelineActorIds: ['user_cdcaa5cd-b162-43f3-ad10-8253a0e4fba6'],
    })
    assert.ok(ids.includes('user_4129a563-f77b-42bf-bb36-2559a5fc1546'))
    assert.ok(ids.includes('user_cdcaa5cd-b162-43f3-ad10-8253a0e4fba6'))
  })
