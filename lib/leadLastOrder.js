...
import { normalizeErpTags, readErpTagsFromLead, hasExplicitErpTagArray } from './erpTags.js'
...
export function buildCrmPayload(entry) {
  ...
  const erp_tags = hasExplicitErpTagArray(entry)
    ? readErpTagsFromLead(entry)
